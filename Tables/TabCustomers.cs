...
namespace PublishingCenter_v2.PublishingCenter.Tables
{
    public class TabCustomers
    {
        ...
        private static void ShowListCustomers()
        {
            ...
            {
                Console.WriteLine("|{0, -8}|{1, -40}|{2, -40}|{3, -20}|{4, -20}|", user_num, customersItem.customer_name, customersItem.address, customersItem.phone, customersItem.full_name_customers);
                Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
                user_num++;
            }
        }
        ...
        private static void Add()
        {
            ...
            customer.full_name_customers = Console.ReadLine();
        ...
        private static void Update()
        {
            ...
            Customers customer = new Customers();
            customer = TemplateInterface<Customers>.GetDataByNumber(number - 1);
            Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
            Console.WriteLine("|{0, -8}|{1, -40}|{2, -40}|{3, -20}|{4, -20}|", "N", "Company name", "Address", "Phone", "Full name customer");
            Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
            Console.WriteLine("|{0, -8}|{1, -40}|{2, -40}|{3, -20}|{4, -20}|", number, customer.customer_name, customer.address, customer.phone, customer.full_name_customers);
            Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
        ...
        private static void Delete()
        {
            ...
            Customers customer = new Customers();
            customer = TemplateInterface<Customers>.GetDataByNumber(delete_number - 1);

            Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
            Console.WriteLine("|{0, -8}|{1, -40}|{2, -40}|{3, -20}|{4, -20}|", "N", "Company name", "Address", "Phone", "Full name customer");
            Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
            Console.WriteLine("|{0, -8}|{1, -40}|{2, -40}|{3, -20}|{4, -20}|", delete_number, customer.customer_name, customer.address, customer.phone, customer.full_name_customers);
            Console.WriteLine("+--------+----------------------------------------+----------------------------------------+--------------------+--------------------+");
        ...
        private static void Search()
        {
            ...
            while (!exit)
            {
                ...
                if (action == "Search")
                {
                    ...
                    string Hql = $"from Customers as e where" +
                         $" e.customer_name like '%{str}%'" +
                         $" or e.address like '%{str}%'" +
                         $" or e.phone like '%{str}%'" +
                         $" or e.full_name_customers like '%{str}%'";

                    List<Customers> customers_tmp = TemplateInterface<Customers>.SearchDataByText(Hql, str);
